...
<rapid:override name="frame-content">
    ...
    <form class="layui-form"  method="post" id="myForm" action="comment/reply">
       <input type="hidden" name="commentPid" value="${comment.commentId }">
        ...
        <input type="hidden" name="commentArticleId" value="${comment.article.articleId }">
        <input type="hidden" name="commentIp" value="${session_user.userLastLoginIp }">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="commentAuthorName"  value="${session_user.userNickname }" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">我的邮箱 </label>
            <div class="layui-input-block">
                <input type="text" name="commentAuthorEmail"  value="${session_user.userEmail }" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">我的网址 </label>
            <div class="layui-input-block">
                <input type="text" name="commentAuthorUrl"  value="${session_user.userUrl }" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
