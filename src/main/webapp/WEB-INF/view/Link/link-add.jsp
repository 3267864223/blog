...
<rapid:override name="frame-content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form" method="post" id="myForm" action="link/add">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">名称
                        ...
                        <input type="text" name="linkName"  autocomplete="off" class="layui-input" required>
                    </div>
                    <br>
                    ...
                    <div class="layui-input-block">联系方式
                        <input type="text" name="linkOwnerContact"  autocomplete="off" class="layui-input" >
                    </div>
                    <br>
                    <div class="layui-input-block">描述
                        <input type="text" name="linkDescription"  autocomplete="off" class="layui-input" >
                    </div>
                    <br>
                    <div class="layui-input-block">Order
                        <input type="number" name="linkOrder"  autocomplete="off" class="layui-input" min="0" max="10">
                    </div>
                    <br>
                    <div class="layui-input-block">
			...
			if(result==true){
				$.ajax({
					...
					success:function(msg){
						alert(msg);
						window.location.href="link/toAdd";
					}
				});
			}
		}
